package in.istore.bitblue.app.home.transactions.totalrevenue;
...
import in.istore.bitblue.app.home.transactions.totalrevenue.filterby.FilterByProdName;
import in.istore.bitblue.app.home.transactions.totalrevenue.filterby.FilterByStaffId;
...
public class TotalRevViewDetails extends ActionBarActivity implements View.OnClickListener {
    ...
    private void setToolbar() {
        ...
        toolTitle.setText("Total Revenue: " + getResources().getString(R.string.rs) + " " + tinyDB.getString("TotalRevenue"));
