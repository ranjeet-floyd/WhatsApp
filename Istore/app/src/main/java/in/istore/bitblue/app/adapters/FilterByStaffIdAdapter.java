...
public class FilterByStaffIdAdapter extends BaseAdapter {
    private ArrayList<SoldProduct> soldProductArrayList;
    private Context context;
    private LayoutInflater mInflater;
    private ViewHolder holder;

    public FilterByStaffIdAdapter(Context context, ArrayList<SoldProduct> soldProductArrayList) {
    ...
    public View getView(int position, View listRow, ViewGroup viewGroup) {
        if (listRow == null) {
            listRow = mInflater.inflate(R.layout.filterbystaffidlistitem, null);
            holder = new ViewHolder();
            holder.prodname = (TextView) listRow.findViewById(R.id.tv_filterbystaffid_prodname);
            holder.quantity = (TextView) listRow.findViewById(R.id.tv_filterbystaffid_quantity);
            holder.totalsales = (TextView) listRow.findViewById(R.id.tv_filterbystaffid_totalsales);
            holder.custmobile = (TextView) listRow.findViewById(R.id.tv_filterbystaffid_custmobile);
            holder.date = (TextView) listRow.findViewById(R.id.tv_filterbystaffid_date);
            listRow.setTag(holder);
        } else
            holder = (ViewHolder) listRow.getTag();

        SoldProduct soldProduct = soldProductArrayList.get(position);
        holder.prodname.setText(soldProduct.getItemName());
    ...
    private static class ViewHolder {
        TextView prodname, quantity, totalsales, custmobile, date;
    }
}
