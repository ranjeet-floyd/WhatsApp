package in.istore.bitblue.app.home.Stocks.listStock;
...
public class ListMyStock extends ActionBarActivity
    ...
    private void setToolbar() {
        ...
        if (CategoryName == null || CategoryName.equals("null"))
            ...
            toolTitle.setText(CategoryName.toUpperCase());
    ...
    private void initViews() {
      ...
      /*  footerView = ((LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE))
        ...
        getAllProductsForCategoryOnServer(StoreId, Key, CategoryName);
        //getAllProductsForCategoryOnLocal();
        setupSearchView();
    }

    private void getAllProductsForCategoryOnLocal() {
        new AsyncTask<String, String, String>() {
            ...
            protected String doInBackground(String... strings) {
                productArrayList = dbprodAdapter.getAllProductForCategory(CategoryName);
                return "";
            }
                ...
                .setNeutralButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int i) {
                                ...
                                if (productArrayList.size() == 0) {
                                    ...
                                    int ret = dbprodAdapter.deleteAllProduct();
                                    if (ret < 0) {
    ...
    private void sortItemsBy(String column) {
        productArrayList = dbprodAdapter.sortBy(column);
    ...
    private class LoadMoreItems extends AsyncTask<String, String, ArrayList<Product>> {
        ...
        protected ArrayList<Product> doInBackground(String... strings) {
            ...
            offset += 10;
            if (dbprodAdapter != null) {
                productsList = dbprodAdapter.getAllProducts(limit, offset);
                return productsList;
            } else
                return null;
        }
    ...
    private void getAllProductsForCategoryOnServer(final int StoreId, final String Key, final String CategoryName) {
        new AsyncTask<String, String, String>() {
            ProgressDialog dialog = new ProgressDialog(ListMyStock.this);
                ...
                // lvcategories.setAdapter(categoryAdapter);
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        try {
                            ...
                            String productSellingPrice = jsonObject.getString("Sellingprice");
                            ...
                            product.setAddedDate(DateUtil.getDateInDD_MM_YY(productAddedDate));
                            product.setSellprice(productSellingPrice);
