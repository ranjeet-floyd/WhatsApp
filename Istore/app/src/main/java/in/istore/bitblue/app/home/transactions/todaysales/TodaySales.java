package in.istore.bitblue.app.home.transactions.todaysales;
...
public class TodaySales extends ActionBarActivity {
    ...
    private void setToolbar() {
        ...
        toolTitle.setText("Today Sales: Rs " + tinyDB.getString("TodaySales"));
    ...
    private void getTodaySales() {
        new AsyncTask<String, String, String>() {
            ...
            protected String doInBackground(String... strings) {
                ...
                String Response = jsonParser.makeHttpUrlConnectionRequest(API.BITSTORE_GET_TOTAL_REVENUE_FOR_ALL_STAFFANDPRODUCTS, nameValuePairs);      //check the API Path
