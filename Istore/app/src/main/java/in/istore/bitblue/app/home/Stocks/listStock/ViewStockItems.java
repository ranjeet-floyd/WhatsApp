...
import in.istore.bitblue.app.home.Stocks.addItem.AddItemsMenu;
...
/*            if (product != null) {
    ...
    private void getProductDetailsOnServer(final String id) {
            ...
            case R.id.b_viewstockitem_update:
                ...
                if (addedquantity == 0) {
                   ...
                   /* long retquant = insertQuantityDetails(id, addedquantity);
                    ...
                    updateProductQuantityOnServer(id, addedquantity);
                }
                break;
        }
    }

    private void updateProductQuantityOnServer(final String id, final int addedquantity) {
        new AsyncTask<String, String, String>() {
            ProgressDialog dialog = new ProgressDialog(ViewStockItems.this);
